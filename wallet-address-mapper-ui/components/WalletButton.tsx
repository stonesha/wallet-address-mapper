...
export default function WalletButton() {
    ...
    return (
        <Button className="flex flex-row items-center" onClick={createWallet}>
            <div className="w-5 h-5 mr-1">
                <svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1024 1024" overflow="visible">
	...
	C675,627,601.2,692,512.1,692z"/>
            ...
            Create/Connect Coinbase SmartWallet
        </Button>
    );
}
