...
export default async function HomePage() {
  ...
  const shipmentsRes: ShipmentResponse = await fetch(`${process.env.BACKEND_URL!}/getAllShipments/${address}`).then(res => res.json())

  //TODO: errors out if there are no shipments
  return (
